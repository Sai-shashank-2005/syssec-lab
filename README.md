# Linux Security Hardening & Monitoring Lab
...
* **Tools:** OpenSSH, UFW / Firewalld, Auditd, Journalctl
...
### Attack Scenarios
To verify the hardening, I simulated several common attack patterns:
